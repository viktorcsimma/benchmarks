...
-- of the builtin GHC backend of Agda.
-- The definitions testing Agda loading
-- are not included;
-- those have been measured in the original file.
{-# OPTIONS --erasure #-}
...
open import Agda.Builtin.String renaming (String to AString)
...
-- as d_forceTree_282 is how MAlonzo will call it:
{-# FOREIGN GHC {-# NOINLINE d_forceTree_282 #-} #-}
...
putCNat : CNat Nat → IO ⊤
putCNat n = putStrLn (primStringFromList (showCNat n))
...
evalForceTree t = putStrLn (primStringFromList (show (cBoolToBool (forceTree t))))
